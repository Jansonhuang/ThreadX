...
/*                                                                        */
/*  09-07-1999     William E. Lamie         Initial ARM Green Hills       */
/*                                            Version 3.0                 */
...
#define TX_DISABLE cpsr_save = _tx_interrupt_disable();  /* Disable interrupts                        */
#define TX_RESTORE _tx_interrupt_enable(cpsr_save);      /* Restore  interrupts                       */
...
CHAR                            _tx_version_id[] = 
                                    "Copyright (c) 1996-2000 Express Logic Inc. * ThreadX ARM/Green Hills Version G3.0f.3.0a *";
#else
